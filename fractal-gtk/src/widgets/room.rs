...
impl<'a> RoomBox<'a> {
    ...
    pub fn widget(&self) -> gtk::Box {
        ...
        widget_box.pack_start(&avatar.widget, true, true, 18);
        ...
        let membership_box = gtk::Box::new(gtk::Orientation::Vertical, 12);
        ...
        members_count_box.add(&members_icon);
        members_count_box.add(&members_count);
