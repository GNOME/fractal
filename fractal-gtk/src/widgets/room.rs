...
impl<'a> RoomBox<'a> {
    ...
    pub fn widget(&self) -> gtk::Box {
        ...
        widget_box.pack_start(&avatar.widget, false, false, 0);
        ...
        details_box.pack_start(&msg, false, false, 0);
        details_box.pack_start(&topic, false, false, 0);
        details_box.pack_start(&idw, false, false, 0);
        ...
        membership_box.pack_start(&members, false, false, 0);
        membership_box.pack_start(&buttons, false, false, 0);

        widget_box.pack_start(&membership_box, false, false, 0);
