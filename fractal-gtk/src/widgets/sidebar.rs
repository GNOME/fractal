...
impl Sidebar {
    pub fn new(container: &gtk::Box) -> Self {
        ...
        let invites = gio::ListStore::new(RowData::static_type());
        let favorites = gio::ListStore::new(RowData::static_type());
        let rooms = gio::ListStore::new(RowData::static_type());
        let low_priority = gio::ListStore::new(RowData::static_type());
